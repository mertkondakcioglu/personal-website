<%@ Page Title="" Language="C#" MasterPageFile="~/MP_Ana.master" AutoEventWireup="true"
    CodeFile="ProgramTanitimlari.aspx.cs" Inherits="ProgramTanitimlari" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_title" runat="Server">
<title>Program Tanıtımları | Devrim ALTINKURT</title>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_main" runat="Server">
    <div id="main">
        <h1>
            Program Tanıtımları Kategorisindeki Yazılar</h1>
                ...
                <div class="pasif" style="width: 100%; clear: both; font-size: smaller; text-align: right;">
                    <span style="padding-left: 3px;">
                        <asp:HyperLink runat="server" ID="lblKategori" Text='<%#Eval("KategoriLink") %>'
                            NavigateUrl='<%#string.Format("ProgramTanitimlari.aspx?Id={0}",Eval("KategoriID")) %>'></asp:HyperLink>
                        -
