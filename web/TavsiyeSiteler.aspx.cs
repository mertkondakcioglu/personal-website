...
public partial class TavsiyeSiteler : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            rptTavsiyeSiteler.DataSource = from x in db.tavsiyesiteler
                                           orderby x.oncelik
                                           select new
                                           {
                                               adi = x.adi,
